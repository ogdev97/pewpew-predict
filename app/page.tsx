...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full p-4 md:p-8 pb-35">
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-dark-card/90 backdrop-blur-lg rounded-3xl border border-gray-800 px-2 py-2">
            <div className="flex justify-around items-center">
              ...
              {/* Predict - Active */}
              <Link href="/" className="flex flex-col items-center gap-1 py-2 px-4 rounded-2xl bg-gradient-to-r from-purple-600/30 to-pink-600/30 border border-purple-500/50">
                <svg className="w-6 h-6 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
                <span className="text-xs text-purple-400 font-semibold">Predict</span>
              </Link>
